...
namespace FinalProject.Husain.POM
{
    public class DiscountPOM
    {
        ...
        IWebElement Subtotal => driver.FindElement(By.XPath("/html//article[@id='post-5']/div[@class='entry-content']/div[@class='woocommerce']//table[@class='shop_table shop_table_responsive']//tr[@class='cart-subtotal']/td/span"));
        ...
        public DiscountPOM CheckCouponAmt()
        {
        ...
        public DiscountPOM CheckTotalAmt()
        {
